...
var ASM_CONSTS = {
  3749356: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3749411: ($0) => { performance.now = function() { return $0; }; },  
 3749459: ($0) => { performance.now = function() { return $0; }; },  
 3749507: () => { performance.now = Module['emscripten_get_now_backup']; }
};
