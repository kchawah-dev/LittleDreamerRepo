...
var ASM_CONSTS = {
  3738124: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3738179: ($0) => { performance.now = function() { return $0; }; },  
 3738227: ($0) => { performance.now = function() { return $0; }; },  
 3738275: () => { performance.now = Module['emscripten_get_now_backup']; }
};
